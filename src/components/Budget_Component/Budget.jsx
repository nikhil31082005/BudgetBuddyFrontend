...
const Budget = ({ user }) => {
    ...
    useEffect(() => {
        const fetchBudgets = async () => {
            try {
                ...
                const response = await axios.get(`https://budgetbuddy-backend-lsl7.onrender.com/budget/${userId}`, { withCredentials: true });
    ...
    const handleAddBudget = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://budgetbuddy-backend-lsl7.onrender.com/budget/addBudget', formData, { withCredentials: true });
    ...
    const handleDeleteBudget = async (budgetId) => {
        try {
            await axios.delete(`https://budgetbuddy-backend-lsl7.onrender.com/budget/deleteBudget/${budgetId}`, { withCredentials: true });
