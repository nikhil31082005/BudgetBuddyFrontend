...
const Goal = ({ user }) => {
    ...
    useEffect(() => {
        const fetchGoals = async () => {
            try {
                ...
                const response = await axios.get(`goal/${userId}`, { withCredentials: true });
    ...
    const handleAddGoal = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://budgetbuddy-backend-lsl7.onrender.com/goal/addGoal', formData, { withCredentials: true });
    ...
    const handleAddToCurrentAmount = async (goalId) => {
        try {
            ...
            await axios.put(`https://budgetbuddy-backend-lsl7.onrender.com/goal/update/${goalId}`, { currentAmount: newAmount }, { withCredentials: true });
